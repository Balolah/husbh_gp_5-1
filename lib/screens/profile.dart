...
//Scores for games
  ...
  Future<void> getScoreLearning() async {
    ...
    // retrive games points
    // DocumentSnapshot<Map<String, dynamic>> ADDGAME = await FirebaseFirestore
    //     .instance
    //     .collection('Game')
    //     .doc(user.uid)
    //     .collection('Score')
    //     .doc("Add")
    //     .get();
    // DocumentSnapshot<Map<String, dynamic>> SUBGAME = await FirebaseFirestore
    //     .instance
    //     .collection('Game')
    //     .doc(user.uid)
    //     .collection('Score')
    //     .doc("Sub")
    //     .get();
    // DocumentSnapshot<Map<String, dynamic>> MULGAME = await FirebaseFirestore
    //     .instance
    //     .collection('Game')
    //     .doc(user.uid)
    //     .collection('Score')
    //     .doc("Mul")
    //     .get();
    // DocumentSnapshot<Map<String, dynamic>> DIVGAME = await FirebaseFirestore
    //     .instance
    //     .collection('Game')
    //     .doc(user.uid)
    //     .collection('Score')
    ...
    // game points
    // addGame = ADDGAME['point'];
    // subGame = SUBGAME['point'];
    // mulGame = MULGAME['point'];
    // divGame = DIVGAME['point'];

    // Learn reports
    addLevel1 = ADD['addLevel1'];
    // addLevel1 = addLevel1.where((element) => element['user'] == user.uid).toList();
    addLevel2 = ADD['addLevel2'];
    // addLevel2 = addLevel2.where((element) => element['user'] == user.uid).toList();
                                            ...
                                            child: GridView(
                                                ...
                                                gridDelegate:
                                                  ...
                                                  mainAxisExtent: height *
                                                      0.25, // here set custom Height You Want
                                                )),
                                          )
                                        ],
                                      ),
                                                  ...
                                                  NiceButtons(
                                                      ...
                                                      onTap: (finish) {
                                                        AwesomeDialog(
                                                          ...
                                                          body: const Center(
                                                              child: Text(
                                                                  ' نقاطك في المحاولة الأخيرة في كل لعبة' +
                                                                      "\n",
                                                                  textAlign:
                                                                      TextAlign
                                                                          .center,
