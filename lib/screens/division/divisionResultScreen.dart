...
class divisionResultScreen extends StatelessWidget {
  ...
  final List userAnswer;
   var totalDivScore;
   var maxTotalDivScore;
  ArabicNumbers arabicNumber = ArabicNumbers();
   var divlevel1scoreArabic;
   var maxLevel1ScoreArabic;
   var divlevel2scoreArabic;
   var maxLevel2scoreArabic;
   var divlevel3scoreArabic;
   var maxLevel3scoreArabic;
  //total score & in arabic
   var totalDivScoreArabic;
   var maxTotalDivScoreArabic;
  ...
  divisionResultScreen({
    ...
    this.maxLevel3ScoreDiv,
     this.qustions,
     this.answers,
     this.userAnswer, this.totalDivScore, this.maxTotalDivScore, this.divlevel1scoreArabic, this.maxLevel1ScoreArabic, this.divlevel2scoreArabic, this.maxLevel2scoreArabic, this.divlevel3scoreArabic, this.maxLevel3scoreArabic, this.totalDivScoreArabic, this.maxTotalDivScoreArabic,
  });
