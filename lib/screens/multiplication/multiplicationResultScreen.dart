...
import 'package:unity_flutter_AR/screens/learn_page.dart';
...
class multiplicationResultScreen extends StatelessWidget {
  ...
  //total score
   var totalMulScore;
   var maxTotalMulScore;
  ArabicNumbers arabicNumber = ArabicNumbers();
   var mullevel1scoreArabic;
   var maxLevel1ScoreArabic;
   var mullevel2sscoreArabic;
   var maxLevel2ScoreArabic;
   var mullevel3scoreArabic;
   var maxLevel3ScoreArabic;
  //total score in arabic
   var totalMulScoreArabic;
   var maxTotalMulScoreArabic;
...
//play audio
  ...
  multiplicationResultScreen({
    ...
    this.maxLevel3ScoreMul,
     this.qustions,
     this.answers,
     this.userAnswer, this.totalMulScore, this.maxTotalMulScore, this.mullevel1scoreArabic, this.maxLevel1ScoreArabic, this.mullevel2sscoreArabic, this.maxLevel2ScoreArabic, this.mullevel3scoreArabic, this.maxLevel3ScoreArabic, this.totalMulScoreArabic, this.maxTotalMulScoreArabic,
  });
