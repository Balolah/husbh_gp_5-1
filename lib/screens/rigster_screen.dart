...
import 'package:unity_flutter_AR/screens/verify_screen.dart';
...
class RegistrationScreenSecond extends StatefulWidget {
  ...
  const RegistrationScreenSecond({Key key, this.em, this.pass})
      : super(key: key);
...
class RegistrationScreenThird extends StatefulWidget {
  ...
  const RegistrationScreenThird(
      {Key key, this.em, this.pass, this.chName, this.age})
      : super(key: key);
