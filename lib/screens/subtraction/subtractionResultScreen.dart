...
class subtractionResultScreen extends StatelessWidget {
  ...
  //total score
   var totalSubScore;
   var maxTotalSubScore;
  ArabicNumbers arabicNumber = ArabicNumbers();
   var subsinglescoreArabic;
   var maxSingleScoreArabic;
   var subtensscoreArabic;
   var maxtensscoreArabic;
   var subhundredscoreArabic;
   var maxhundredscoreArabic;
  //total score in arabic
   var totalSubScoreArabic;
   var maxTotalSubScoreArabic;
  ...
  subtractionResultScreen({
    ...
    this.maxHundredScore,
     this.qustions,
     this.answers,
     this.userAnswer, this.totalSubScore, this.maxTotalSubScore, this.subsinglescoreArabic, this.maxSingleScoreArabic, this.subtensscoreArabic, this.maxtensscoreArabic, this.subhundredscoreArabic, this.maxhundredscoreArabic, this.totalSubScoreArabic, this.maxTotalSubScoreArabic,
  });
