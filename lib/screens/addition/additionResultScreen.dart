...
class additionResultScreen extends StatelessWidget {
  ...
  final List userAnswer;
   var totalAddScore;
   var maxTotalAddScore;
  ArabicNumbers arabicNumber = ArabicNumbers();
   var addsinglescoreArabic;
   var maxSingleScoreArabic;
   var addtensscoreArabic;
   var maxtensscoreArabic;
   var addhundredscoreArabic;
   var maxhundredscoreArabic;
//total score & in arabic
   var totalAddScoreArabic;
   var maxTotalAddScoreArabic;
  ...
  additionResultScreen({
    ...
    this.maxHundredScore,
     this.qustions,
     this.answers,
     this.userAnswer, this.totalAddScore, this.maxTotalAddScore, this.addsinglescoreArabic, this.maxSingleScoreArabic, this.addtensscoreArabic, this.maxtensscoreArabic, this.addhundredscoreArabic, this.maxhundredscoreArabic, this.totalAddScoreArabic, this.maxTotalAddScoreArabic,
  });
