 ...
 */
  ...
  public void DisplaySubtractionMathProblem() {
    ...
    answerOne = firstNumberInProblem - secondNumberInProblem;
     ...
     while (answerOne<0 || answerOne>250) {
    //first number
...
public void MessengerFlutter()
    {
        ...
        UnityMessageManager.Instance.SendMessageToFlutter("S"+subtractionScore);
    }
  ...
  public void starArcheived() {
     if (subtractionScore >= 1 && subtractionScore <5 ) {
      //one star 
     star[0].SetActive(true);
    } else if (subtractionScore >= 5 && subtractionScore < 8) {
      //two stars
      star[0].SetActive(true);
      star[1].SetActive(true);
    } else if (subtractionScore >= 8 && subtractionScore < 13) {
      //three stars
      star[0].SetActive(true);
      star[1].SetActive(true);
